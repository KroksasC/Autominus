...
function Edit() {
    ...
    const [cityInput, setCityInput] = useState(car?.city || "");
    const [filteredCities, setFilteredCities] = useState([]);
    const [showCityDropdown, setShowCityDropdown] = useState(false);
    const [previewImages, setPreviewImages] = useState(car?.imageUrls?.map(url => ({
        url,
        name: url.split('/').pop(),
        status: 'done'
    })) || []);
    ...
    useEffect(() => {
        if (car) {
            ...
            setCityInput(car.city || "");
            if (car.imageUrls) {
                setPreviewImages(car.imageUrls.map(url => ({
                    url,
                    name: url.split('/').pop(),
                    status: 'done'
                })));
    ...
    const handleSubmit = async (e) => {
        ...
        const updatedFormData = {
            ...
            technicalInspectionValidUntil: formData.technicalInspectionValidUntil ? new Date(formData.technicalInspectionValidUntil).toISOString() : null,
            imageUrls: formData.imageUrls.filter(url => url.trim() !== ""),
        };

        try {
            updatedFormData.id = carID;
        ...
        <div>
            ...
            <form className="main" onSubmit={handleSubmit}>
                ...
                <div className="input-group">
                    ...
                    <input type="number" id="mileage" name="mileage" placeholder="Įveskite ridą" onChange={handleChange} value={formData.mileage || ""} />
                ...
                <div className="input-group">
                    ...
                    <input type="number" id="engineCapacity" name="engineCapacity" placeholder="Įveskite variklio tūrį" step="0.1" onChange={handleChange} value={formData.engineCapacity || ""} />
                ...
                <div className="input-group">
                    ...
                    <input type="number" id="horsepower" name="horsepower" placeholder="Įveskite variklio galią" onChange={handleChange} value={formData.horsepower || ""} />
                ...
                <div className="input-group">
                    ...
                    <input type="number" id="doors" name="doors" placeholder="Įveskite durų skaičių" onChange={handleChange} value={formData.doors || ""} />
                ...
                <div className="input-group">
                    ...
                    <input type="number" id="seats" name="seats" placeholder="Įveskite sėdimų vietų skaičių" onChange={handleChange} value={formData.seats || ""} />
                ...
                <div className="input-group">
                    ...
                    <input type="text" id="registrationNumber" name="registrationNumber" placeholder="Įveskite registracijos numerį" onChange={handleChange} value={formData.registrationNumber || ""} />
                ...
                <div className="input-group">
                    ...
                    <input type="number" id="price" name="price" placeholder="Įveskite kainą" onChange={handleChange} value={formData.price || ""} />
                ...
                <div className="form-actions">
                    <Link to={`/${car.id}`} className="cancel-btn">Atšaukti</Link>
                    <button type="submit" className="submit-btn">Redaguoti</button>
                </div>

                {showConfirmation && (
                    <div className="confirmation-popup">
                        <div className="popup-content">
                            <h3>Skelbimas sėkmingai atnaujintas</h3>
